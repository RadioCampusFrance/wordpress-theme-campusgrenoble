		...
		<div class="navigation section no-padding bg-dark">
			...
			<div class="navigation-inner section-inner">
				...
				<ul class="main-menu">
				 ...
				 <a class="nav-social nav-rss" href="/feed/" target="_blank">&nbsp;</a>

				 <?php if ( get_theme_mod( 'baskerville_twitter' ) ) : ?>
				 <a class="nav-social nav-twitter" href="<?php echo esc_url( get_theme_mod( 'baskerville_twitter' ) ); ?>" target="_blank">&nbsp;</a>
				 <?php endif; ?>

				 <?php if ( get_theme_mod( 'baskerville_facebook' ) ) : ?>
				 <a class="nav-social nav-facebook" href="<?php echo esc_url( get_theme_mod( 'baskerville_facebook' ) ); ?>" target="_blank">&nbsp;</a>
				 <?php endif; ?>
