...
<div class="credits section bg-dark small-padding">
	...
	<div class="credits-inner section-inner">
		...
		<p class="credits-right fright">
			...
			<span><?php printf( __( 'Theme by <a href="%s">Anders Noren</a> and Martin Kirchgessner', 'baskerville'), 'http://www.andersnoren.se' ); ?> &mdash; </span><a class="tothetop" title="<?php _e('To the top', 'baskerville'); ?>" href="#"><?php _e('Up', 'baskerville' ); ?> &uarr;</a>
